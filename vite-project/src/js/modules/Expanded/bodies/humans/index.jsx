...
export default function HumansBody(properties) {
  ...
  let langLevelElement = languages.map((lang, index) => {
    ...
    return (
      <div class="row language-elem my-3" data-name="lang-level">
        <div class="col">{langType}</div>
        <div class="col">{langLvl}</div>
        <div className="col-auto d-flex align-items-center align-items-md-end justify-content-end">
          <div
            className="btn btn-danger"
            data-name="languages"
  ...
  let certificatesElem = certificates.map((elem, index) => {
    ...
    return (
      <div className="row certificates-elem my-3">
        <div className="col-12">
          <img src={serverUrl + funcs.state.certificates[index].photo} alt="" />
        </div>
        <div className="row">
          <div className="col">
            <div className="row">
              <div className="col-12 col-md">
                <input
                  ...
                  value={funcs.state.certificates[index].name}
                  onChange={(e) => funcs.handleChange(e)}
                />
              </div>
              <div className="col-12 col-md mt-3 mt-md-0">
                <input
                  class="form-control"
                  type="file"
                  name={`cert-${elem.professor}-` + index}
                  accept="image/png, image/jpeg"
                />
              </div>
              <div className="col-12 mt-3">{prof}</div>
            </div>
          </div>
          <div className="col-auto d-flex align-items-center justify-content-end">
            <div
  ...
  if (photo !== '') {
    photoPicture = (
      <img src={serverUrl + photo} width={'100%'} alt="" className="mb-3" />
    );
  }
  return (
    <div style={style}>
      <div class="container" ref={(c) => (funcs.rootElem = c)}>
        ...
        <div class="row">
          <div class="col d-flex justify-content-center">
            <h1 class="my-5">
              {props.info.mode === 'add' ? 'Додати' : 'Редагувати'} людину
            </h1>
          </div>
        </div>
        <div class="row">
          <div class="col">
            ...
            >
                ...
                <div class="col-12 col-md-6">
                  <div class="mb-4 video-elem">
                    <label class="form-label">
                      Відео <strong className="seccond-text">(.mp4)</strong>
                    </label>
                    <br />
                    {videoElem}
                    <div
                      class="btn btn-success"
                      onClick={() => funcs.addField('video', 2)}
                    >
                      Додати Відео
                    </div>
                  </div>
              ...
              <div class="mb-3 mt-5">
                <label class="form-label mb-0">Рівень володіння мовою</label>
                <br />
                {langLevelElement}
                <div
                  class="btn btn-success"
                  onClick={() => funcs.addField('languages', 2)}
                >
                  Додати Мову
                </div>
              </div>
              <div class="mb-3 mt-5">
                <label class="form-label">Сертифікати</label>
                <br />
                {certificatesElem}
                <div
                  class="btn btn-success"
                  onClick={() => funcs.addField('certificates')}
                >
                  Додати Сертифікат
                </div>
              </div>
